...
const mapPostRow = (row) => {
  const post = {
    ...
    featured_image_title: row.featured_image_title || "",
...
export const createPost = async (data) => {
  ...
  const [result] = await blogDb.query(
    `INSERT INTO blog_posts
      (title, slug, excerpt, content, featured_image, featured_image_title, featured_image_alt,
...
export const updatePost = async (id, data) => {
  ...
  const {
    ...
    content,
    featured_image = "",
    featured_image_title = existing.featured_image_title || "",
  ...
  await blogDb.query(
    `UPDATE blog_posts
     SET title = ?, slug = ?, excerpt = ?, content = ?, featured_image = ?,
         featured_image_title = ?, featured_image_alt = ?,
         meta_title = ?, meta_description = ?, focus_keyword = ?, canonical_url = ?,
         robots_noindex = ?, robots_nofollow = ?,
         og_title = ?, og_description = ?, og_image = ?,
         twitter_title = ?, twitter_description = ?, twitter_image = ?,
...
export const toWordPressShape = (post, settings = {}) => {
  ...
  return {
    ...
    featured_image: normalizeFeaturedImage(post.featured_image, settings),
    featured_image_title: post.featured_image_title || "",
